...
function MyVerticallyCenteredModal(props) {
  return (
    <Modal
      {...props}
      dialogClassName="modal-widthpromo"
        ...
        <Row>
          <Col>
            ...
            <Row className="p-4">
              ...
              <Col sm={8} style={{ border: "1px solid gray" }}>
                <TextField
                  id="date"
                  type="date"
            ...
            <Row className="p-4">
              <Col sm={4}>
                <label style={{fontSize:12}}><b>Validity(in days)</b></label>
                <span style={{ color: "red" }}>*</span>
              </Col>
              <Col sm={8}>
                <input
          ...
          <Col>
            ...
            <Row className="p-4">
              ...
              <Col sm={8}>
                <select className="h-7 focus:outline-none rounded border-2 border-gray-400 w-60 pl-1 fcs">
  ...
  return (
    <div>
      <div className="flex shadow-md h-16 items-center justify-center">
        <p className="font-bold text-2xl">Promo Codes</p>
      </div>
      <div className="m-4">
        <Button

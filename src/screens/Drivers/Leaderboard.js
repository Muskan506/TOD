  ...
  return (
    <div>
      <div className="flex shadow-md h-16 items-center justify-center">
        <p className="font-bold text-2xl">Driver Leaderboard</p>
      </div>
      <div className="flex items-center h-16 ml-10 mt-4 font-bold">
      ...
      <div className="h-full border border-indigo-600 m-4 bg-white">
        ...
        <div className="h-16 flex items-center justify-between flex-wrap">
          <div>

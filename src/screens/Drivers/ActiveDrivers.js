  ...
  return (
    <div>
      <div className="flex shadow-md h-16 items-center justify-center">
        <p className="font-bold text-2xl">Active Drivers</p>
      </div>
      <div className="flex-wrap h-20 shadow-lg">
        <button
          className="font-bold text-base text-center shadow-xl w-24 h-8 ml-4 mt-4 text-white rounded focus:outline-none"
          style={{ backgroundColor: "#ff6600" }}
        >
          Add Driver
        </button>
      </div>
      <div className="flex justify-center h-20 shadow-lg m-4  pl-4 pr-4 border border-indigo-600">
        <input
          type="email"
          className="input-width text-center my-4 focus:outline-none focus:ring-1 focus:ring-blue-300 border border-indigo-600 text-sm h-8"
          placeholder="Driver ID, Driver Name, Mobile, Email, Vehicle Number "
        />
        <button
          className="font-bold text-base text-center shadow-xl w-24 h-8  mt-4 text-white focus:outline-none"
          style={{ backgroundColor: "#ff6600" }}
        >
          Search
        </button>
        <button
          className="font-bold text-base text-center shadow-xl w-24 h-8 ml-4 mt-4 text-white focus:outline-none"
          style={{ backgroundColor: "#ff6600" }}
        >
          See All
        </button>
